...
export async function PATCH(
  ...
  const fields: { system_prompt?: string; role?: string; proxy_agent_id?: string | null; monthly_budget?: number | null; agent_mode?: "ai" | "facade" } = {};
  ...
  if (body.agent_mode === "ai" || body.agent_mode === "facade") {
    fields.agent_mode = body.agent_mode;
  }
